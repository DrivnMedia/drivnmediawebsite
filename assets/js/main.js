...
(function () {
  ...
  const WEBHOOK_URL = "[PASTE GHL WEBHOOK URL HERE]";
  ...
  if (form) {
    ...
    form.addEventListener("submit", async (e) => {
      ...
      // 1) Early capture: POST to the webhook (fire-and-forget so the calendar opens
      //    instantly; the lead is captured even if they never finish booking).
      ...
      if (!notConfigured) {
        ...
        console.warn("[Drivn Media] WEBHOOK_URL not set, skipping POST. Lead:", payload);
      }
